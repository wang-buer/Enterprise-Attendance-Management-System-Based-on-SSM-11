...
<div class="container">
  ...
  <div class="layui-inline" style="margin-top: 10px;">
    ...
    <div class="layui-input-block">
      <input type="text" name="adept_name" id="adept_name" value="${adeptName}" required  lay-verify="required" placeholder="姓名" autocomplete="off" class="form-control">
    </div>
  </div>
  <div class="layui-inline">
    <label class="layui-form-label" >部门描述:</label>
    <div class="layui-input-block">
 <textarea  placeholder="请输入内容" class="layui-textarea" id="adept_ads"  name="adept_ads">
<c:out value="${adeptades}"></c:out>
 </textarea>   
 <input type="hidden" value="${adeptId }" id="adept_id" name="adept_id">
  </div>
  </div>
